...
class Avangrid(CustomerBase):
    ...
    def __init__(self):
        ...
        Avangrid
        """
        self.__name = 'Avangrid'
        self.__geo_location = GeographicalLocation(lat=34.918756, long=-118.444534)
        self.__farms = [WindFarm('Manzana-Wind', self.__geo_location)]
